...
const Feedback: React.FC = () => {
  return (
    <div className="py-32 bg-slate-50 bg-slate-900 transition-colors duration-300 border-t border-slate-200 border-white/5">
            ...
            <div className="relative z-10 p-10 md:p-20 text-center">
              <div className="max-w-3xl mx-auto space-y-10">
                ...
                <div className="grid sm:grid-cols-3 gap-6 py-6">
                  <div className="p-6 rounded-3xl bg-slate-900 border border-slate-200 dark:border-white/5 space-y-3">
                    ...
                    <p className="text-sm font-bold text-white">Mudah Diisi</p>
                    <p className="text-xs text-slate-400">Hanya perlu beberapa menit.</p>
                  </div>
                  <div className="p-6 rounded-3xl bg-slate-900 border border-slate-200 dark:border-white/5 space-y-3">
                    ...
                    <p className="text-sm font-bold text-white">Apresiasi</p>
                    <p className="text-xs text-slate-400">Masukan Anda kami hargai.</p>
                  </div>
                  <div className="p-6 rounded-3xl bg-slate-900 border border-slate-200 dark:border-white/5 space-y-3">
                    ...
                    <p className="text-xs text-slate-400">Langsung ke tim panitia.</p>
                  </div>
                </div>
